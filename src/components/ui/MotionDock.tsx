  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 w-[90%] max-w-5xl">
        <div className="rounded-2xl backdrop-blur-xl bg-slate-900/40 border border-white/10 px-6 py-4 flex flex-col lg:flex-row items-center gap-6 justify-between shadow-2xl">
