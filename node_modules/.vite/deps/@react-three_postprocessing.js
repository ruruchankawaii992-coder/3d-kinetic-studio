...
var EffectComposer2 = (0, import_react.memo)(function EffectComposer3({ children, camera: _camera2, scene: _scene, resolutionScale, enabled = true, renderPriority = 1, autoClear = true, autoRenderToScreen = true, depthBuffer, enableNormalPass, stencilBuffer, multisampling = 8, frameBufferType = HalfFloatType, renderPass = defaultRenderPass, mergeMode = "auto", ref }) {
  ...
  const [, requestRebuild] = (0, import_react.useReducer)((c2) => c2 + 1, 0);
  (0, import_react.useEffect)(() => {
  ...
  (0, import_react.useLayoutEffect)(() => {
    ...
    if (updateIfChanged(nodesRef, nodes)) setNodesVersion((v4) => v4 + 1);
  });
  (0, import_react.useLayoutEffect)(() => {
    if (!composerState) return;
...
var ASCIIEffect = class extends Effect {
  constructor({ font = "arial", characters = ` .:,'-^=*+?!|0#X%WM@`, fontSize = 54, cellSize = 16, color: color2 = "#ffffff", invert = false } = {}) {
...
function SSAO({ blendFunction = 21, samples = 30, rings = 4, distanceThreshold = 1, distanceFalloff = 0, rangeThreshold = 0.5, rangeFalloff = 0.1, luminanceInfluence = 0.9, radius = 20, bias = 0.5, intensity = 1, color: color2, worldDistanceThreshold, worldDistanceFalloff, worldProximityThreshold, worldProximityFalloff, minRadiusScale, fade, depthAwareUpsampling = true, resolutionScale, resolutionX, resolutionY, width, height, ref }) {
...
function N8AO({ enabled = true, halfRes, screenSpaceRadius, quality, depthAwareUpsampling = true, aoRadius = 5, aoSamples = 16, denoiseSamples = 4, denoiseRadius = 12, distanceFalloff = 1, intensity = 1, color: color2, renderMode = 0, ref }) {
